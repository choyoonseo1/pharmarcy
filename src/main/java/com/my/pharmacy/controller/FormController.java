...
public class FormController {
    ...
    public String searchAddress(InputDto dto, Model model) {
        ...
        // 카테고리 서비스 호출을 위해 documents 배열에서 0번째 것 만 뺀다.
        ...
        List<OutputDto> outputDtoList =
                kakaoCategorySearchService.makeOutPutDto(recommendationDto.getDocumentList());
        model.addAttribute("ouputList", outputDtoList);
        return "output";
    }
}
